from models import BiLSTM_Attention, RNN, Logistic
import numpy as np
...
def main(args):
    ...
    if args.MODEL_NAME == "Attn_BiLSTM":
        ...
        #N_HIDDEN = 32
        NUM_CLASSES = 3
        args.model = Logistic.Logistic(dropout_rate=DROPOUT, vocab_size=args.INPUT_DIM, embedding_dim=args.EMBEDDING_DIM, output_dim=NUM_CLASSES)
